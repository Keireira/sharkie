...
export const getCurrencyCategory = (code: string): CurrencyCategory => CURRENCY_CATEGORIES[code] || 'other';

export const ALL_CATEGORIES: CurrencyCategory[] = [
	'major',
	'europe',
	'asia',
	'americas',
